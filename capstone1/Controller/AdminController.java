...
public class AdminController {
    ...
    public ResponseEntity updateOrderStatus(@PathVariable String adminid, @PathVariable String orderId) {
    ...
    public ResponseEntity getRefundRequests(@PathVariable String adminid) {
