...
public class OrderController {
    ...
    public ResponseEntity<String> buyProduct(@PathVariable String userId,
    ...
    public ResponseEntity createOrder(@PathVariable String userid,@PathVariable String merchantId) {
