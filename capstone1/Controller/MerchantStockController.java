...
public class MerchantStockController {
    ...
    public ResponseEntity update(@PathVariable String merchantStockId, @RequestBody @Valid MerchantStock merchantStock, Errors errors) {
        if (errors.hasErrors()) {
            return ResponseEntity.status(400).body(errors.getFieldError().getDefaultMessage());
        }
    ...
    public ResponseEntity delete(@PathVariable String merchantStockId) {
